...
public class CinderSoulStatusEffect extends DamageModifierStatusEffect {
    public CinderSoulStatusEffect() {
        super(StatusEffectCategory.BENEFICIAL, 0xff5900, 1.0D);
    ...
    public double adjustModifierAmount(int amplifier, EntityAttributeModifier modifier) {
        return this.modifier * modifier.getValue();
    }
}
