...
public class DesolationMod implements ModInitializer {
	...
	private static Biome createCharredForest(boolean isClearing, boolean isSmall) {
		SpawnSettings.Builder spawnSettings = new SpawnSettings.Builder()
				.spawn(SpawnGroup.AMBIENT, new SpawnSettings.SpawnEntry(DesolationEntities.ASH_SCUTTLER, 1, 1, 2))
				.spawn(SpawnGroup.MONSTER, new SpawnSettings.SpawnEntry(DesolationEntities.BLACKENED, 1, 1, 3));
